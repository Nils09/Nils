...
public class login implements ActionListener {
	...
	//	this.password=textField.getText();
		...
		lblLoginicon.setIcon(new ImageIcon("C:\\Users\\Nilesh\\Desktop\\Packer_Unpacker\\icons8-customer-64.png"));
		lblLoginicon.setBounds(656, 232, 75, 48);
		frame.getContentPane().add(lblLoginicon);
		
		label = new JLabel("");
		label.setIcon(new ImageIcon("C:\\Users\\Nilesh\\Desktop\\Packer_Unpacker\\icons8-password-60.png"));
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(username.equals("Nilesh")&&password.equals("Nilesh"))
		{
